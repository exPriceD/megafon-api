...
func buildDevelopmentConfig() zapcore.EncoderConfig {
	...
	cfg.EncodeLevel = zapcore.CapitalColorLevelEncoder           // Цветные уровни логов
	cfg.EncodeTime = zapcore.TimeEncoderOfLayout("15:04:05.000") // Короткое время
	cfg.EncodeCaller = zapcore.FullCallerEncoder                 // Полный путь к файлу
